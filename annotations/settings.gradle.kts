 ...
 */
logger.info("\n")
logger.info("    ==========                      Start of settings.gradle.kts from annotations                      ==========\n")
...
val kmpbuildlogicAnnotationsProjectName =
    mainRootProjectName +
        "-" +
        "Annotations
rootProject.name = kmpbuildlogicAnnotationsProjectName

logger.info("\n")
logger.info("    ==========                       End of settings.gradle.kts from annotations                       ==========\n")
